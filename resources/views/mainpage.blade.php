...
<body>
    ...
    <div>
        <button class="w3-button w3-round w3-right w3-blue w3-margin" onclick="document.getElementById('newsubject').style.display= 'block';return false;">New Subject</button>
    </div>
